...
export default async function Video({ params }: PageProps) {
	...
	const jsonLd = {
        ...
        url: `https://bokepdigilirteman.pages.dev/v/${file.filecode}#${file.title}`,
